...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المساعدة والدعم - العملاء</h4>
            </div>
        </div>
...
@section('content')
                                        ...
                                        <div class="position-relative">
                                            <div class="chat-messages p-4">
                                                ...
                                                <div class="chat-message-left pb-4" id="{{$message->id}}" >
                                                    ...
                                                    <div class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                        <div class="font-weight-bold mb-1">{{ $client->user_name }}</div><p  ><strong>{{  $message->title }}</strong></p><p>{{  $message->content }}</p></div>
                                                </div>
                                                @endif
    ...
    <div class="chat-message-left pb-4" style="display: none" id="client-msg" >
        ...
        <div class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
            <div class="font-weight-bold mb-1">{{ $client->user_name }}</div><p   ><strong class="msg-title"></strong></p><p class="msg-content"></p></div>
    </div>
@endsection
@section('css')
