...
<body>
    ...
    <div class="col-12">
        ...
        <div class="lead code-div">
            ...
            <p>لقد قمت بإرسال طلب حذف حسابك من تطبيق روح</p>
            <div>
              ...
              <div class="info">   <span> الموبايل:</span><strong class="code-style">{{ $data['client_mobile'] }}</strong><br/>    </div>
			   ...
			   <div class="info">سوف يتم مراجعة طلبك من قبل الادارة وحذف الحساب خلال مدة لاتتجاوز /20/ يوم من تاريخ ارسال الطلب.</div>
        </div>
